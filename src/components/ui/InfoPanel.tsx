              ...
              <div className="space-y-6">
                ...
                <div className="bg-teal-500/10 border border-teal-500/30 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-teal-600 hover:bg-teal-500 text-white text-xs font-semibold shadow-md transition-all cursor-pointer"
                  >
                    {copiedEmail ? (
                      <>
                ...
                <div className="bg-slate-800/40 rounded-2xl p-4 border border-white/10">
                  ...
                  <p className="text-xs text-slate-400 mb-3">
                    Have an upcoming website project or need ongoing WordPress/Shopify support?
                  </p>
                  <a
                    href="mailto:eric.zaragoza27@gmail.com?subject=Inquiry%20from%20Portfolio%20Visitor&body=Hi%20Eric,%0D%0A%0D%0AI%20explored%20your%203D%20portfolio%20and%20would%20love%20to%20discuss%20a%20project."
                    className="inline-flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white text-xs font-bold shadow-lg transition-all"
                  >
